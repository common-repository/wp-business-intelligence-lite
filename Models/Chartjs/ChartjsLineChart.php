...
// TODO: uncovered
class ChartjsLineChart extends AbstractChart {

  protected $chartSlug = 'chartjs-line-chart';
  ...
  public function getHtml($caption) {
    ...
    return (new Engine(Settings::platesDirectory()))
      ->render('chart/chartjs/line-chart',
  ...
  public static function getHtmlForWpData($id, $maps, $args, $caption) {
    #self::enqueueAssetsChartjs();
    return (new Engine(Settings::platesDirectory()))
      ->render('chart/chartjs/line-chart',
        array('chartId' => $id,
          'options' => $args,
          'chartLabels' => $maps['labels'],
          'chartData' => $maps['data'],
          'assets' => Settings::plugin_asset_path(),
          'caption' => $caption));
  }
