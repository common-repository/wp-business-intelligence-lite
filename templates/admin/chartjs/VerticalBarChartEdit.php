<?php $this->layout('admin/baseLayout', array('title' => 'Edit Vertical Bar Chart')) ?>
<form id='edit-vertical-bar-charts' action='<?=$this->e($action)?>' method='post'>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <p class="description">A column with human readable names. Is the labels for the bar.</p>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          ...
          <p class="description">A column with numeric values. Represents the end data series of the bar.</p>
        </td>
      </tr>
...
<?php $this->insert('admin/partials/ChartShortcode', array('chartId' => $chart->id, 'chartType' => 'vertical bar')) ?>
