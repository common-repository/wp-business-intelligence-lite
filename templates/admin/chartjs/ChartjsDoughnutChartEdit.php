<?php $this->layout('admin/baseLayout', array('title' => 'Edit Doughnut Chart')) ?>
...
<?php $this->insert('admin/partials/ChartShortcode', array('chartId' => $chart->id, 'chartType' => 'chartjs doughnut')) ?>
